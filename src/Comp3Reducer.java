...
public class Comp3Reducer extends Reducer< IntWritable, Text, IntWritable, Text> {
public static int[] P=new int[MridulMRCwith3.v-2*(int)Math.floor(MridulMRCwith3.v/3)];
...
//P(u)=min(u,min(v|v is neighbor of u))
    ...
    for(Text value:values)
 {
   ...
   P[key.get()-2*(int)Math.floor(MridulMRCwith3.v/3)-1]=vmin; 
    }
}